...
public class ModificationRapForm {
    private static final String CHAMP_ID         = "id_rap";
    ...
    public ModificationRapForm( RapportDAO rapportDao, ActionDAO actionDao ) {
    ...
    public Rapport modifierRap( HttpServletRequest request ) {
        ...
        if ( erreurs.isEmpty() ) {
            ...
            try {
                rapportDao.modifier( rapport, rapport.getAction(), rapport.getNom_rap(), rapport.getFile_rap(),
                        rapport.getId_rap() );
            } catch ( Exception e ) {
