...
public class ModificationActionForm {
    ...
    public ModificationActionForm( ActionDAO actionDao ) {
    ...
    public Action modifier( HttpServletRequest request ) {
        System.out.println( getValeurChamp( request, CHAMP_ID ) );
        System.out.println( getValeurChamp( request, CHAMP_NOM_ACTION ) );
        System.out.println( getValeurChamp( request, CHAMP_ANNEE ) );
        System.out.println( getValeurChamp( request, CHAMP_LCE ) );
        ...
        if ( erreurs.isEmpty() ) {
            ...
            try {
                actionDao.modifier( action, action.getNom_action(), action.getNom_proc(), action.getProcédure(),
                        action.getNom_chlist(), action.getChecklist(), action.getAnnée(), action.getLce(),
                        action.getId() );
            } catch ( Exception e ) {
