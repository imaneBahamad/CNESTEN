...
public class AjoutUtilisateurForm {
    ...
    private void traiterMotsDePasse( String motdepasse, String confirmation, Utilisateur utilisateur ) {
         ...
         * efficacement.L'algorithme SHA-256 est ici utilisé, avec par défaut un
         * salage aléatoire et un grand nombre d'itérations de la fonction de
         * hashage. La String retournée est de longueur 56 et contient le hash
         * en Base64.
         */
    ...
    private void validationNom( String nom ) throws FormValidationException {
        if ( nom != null ) {
            if ( nom.length() < 2 )
                ...
                throw new FormValidationException( "Ce nom existe déjà." );
            }
        } else
