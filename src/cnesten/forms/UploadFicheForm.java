...
public class UploadFicheForm {
    ...
    public UploadFicheForm( FicheDAO ficheDao, ActionDAO actionDao ) {
    ...
    public Fiche upload( HttpServletRequest request ) {
